...
SGIEnumerate::SGIEnumerate(int ntour_in, int *vtour_in, 
			   int *ftour_in, int *etour_in, MPI_Comm world_in)
{
  ntour = ntour_in;
  vtour = vtour_in;
  ftour = ftour_in;
...
double SGIEnumerate::run(MapReduce *mrv, MapReduce *mre,
...
void SGIEnumerate::map1(uint64_t itask, char *key, int keybytes, 
...
void SGIEnumerate::map2(uint64_t itask, char *key, int keybytes, 
			char *value, int valuebytes, KeyValue *kv, void *ptr) 
{
...
void SGIEnumerate::map3(uint64_t itask, char *key, int keybytes, 
			char *value, int valuebytes, KeyValue *kv, void *ptr) 
{
  SGIEnumerate *sgi = (SGIEnumerate *) ptr;
  int itour = sgi->itour;
...
void SGIEnumerate::reduce1a(char *key, int keybytes, 
...
void SGIEnumerate::reduce1b(char *key, int keybytes, 
			    char *multivalue, int nvalues, int *valuebytes,
			    KeyValue *kv, void *ptr) 
{
  VERTEX vi,vj;
...
void SGIEnumerate::reduce3(char *key, int keybytes, 
			   char *multivalue, int nvalues, int *valuebytes,
			   KeyValue *kv, void *ptr) 
{
  int i,j,k;
...
void SGIEnumerate::x2print(uint64_t itask, char *key, int keybytes, 
			   char *value, int valuebytes, 
			   KeyValue *kv, void *ptr) 
{
  SGIEnumerate *sgi = (SGIEnumerate *) ptr;
...
void SGIEnumerate::x3print(uint64_t itask, char *key, int keybytes, 
			   char *value, int valuebytes, 
			   KeyValue *kv, void *ptr) 
{
  VERTEX vi = *(VERTEX *) key;
...
void SGIEnumerate::tprint(uint64_t itask, char *key, int keybytes, 
			  char *value, int valuebytes, KeyValue *kv, void *ptr) 
{
  VERTEX v = *(VERTEX *) key;
