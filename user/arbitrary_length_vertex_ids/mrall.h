...
/////////////////////////////////////////////////////////////////////////////
//  Data type for number of matrix and vector row/column indices.  
...
/////////////////////////////////////////////////////////////////////////////
//  Data type for each row (vertex).  We'll represent a key as a string 
//  instead of as an integer.  After all, we don't do math on them.
#define KEYLENGTH 16

class VERTEX {
public:
  VERTEX() {memset(v, 0, KEYLENGTH);}
  VERTEX(IDTYPE i) {Set(i);}
  void Set(IDTYPE i) {
    memset(v, 0, KEYLENGTH); 
    IDTYPE *iv = (IDTYPE *) &v;
    *iv = i;
  }
  ~VERTEX() {}
...
class INTDOUBLE {
public:
  VERTEX i;      // When INTDOUBLE is used as a nonzero A_ij in the matrix,
